...
REACT_APP_SHOW_PROMPT_TOKENS: 是否显示"提示"列，true 或 false
REACT_APP_SHOW_COMPLETION_TOKENS: 是否显示"补全"列，true 或 false
REACT_APP_SHOW_CONTENT_DETAIL: 是否显示"详情"列，true 或 false
```
